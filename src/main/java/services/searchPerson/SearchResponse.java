 ...
 *       &lt;sequence>
 *         &lt;element name="personList" type="{http://services.webservice.com/}personResponse" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class SearchResponse {
    ...
    protected List<PersonResponse> personList;
    ...
    public List<PersonResponse> getPersonList() {
        if (personList == null) {
            personList = new ArrayList<PersonResponse>();
        }
